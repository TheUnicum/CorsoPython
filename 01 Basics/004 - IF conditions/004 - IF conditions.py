...
print 'Il risultato di 2 < 6 vale :', 2 < 6
print '2 != 3 :', 2 != 3
print 'type(2) == type(45) :', type(2) == type(45)  # noqa
print 'type(2) == type(45.0):', type(2) == type(45.0) # noqa
print '2 == 2.0:', 2 == 2.0, '   NB!!!!! uguaglianza come valore delle variabili' # noqa
print 'type(2) == type(2.0):', type(2) == type(45.0), 'NB!!!!! uguaglianza come TIPO delle variabili' # noqa
print
